        ...
        <>
            ...
            <div className="blog-container">
                <div className="blog-heading">
                    <p>This is the Main heading of the Blog</p>
                </div>

                <div className="blog-user">
                    <img src="https://via.placeholder.com/40x40" alt="user profile"></img>
                    <p><a>Virinchi Dangeti</a></p>
                </div>

                <div className="blog-image">
                    <img src="https://via.placeholder.com/800x400" alt="Blog related image"></img>
                </div>
