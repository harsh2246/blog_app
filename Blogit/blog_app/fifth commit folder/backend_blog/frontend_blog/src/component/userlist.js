  ...
  return (
    <div>
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)}>
        ...
        <Modal.Body>
          Are you sure you want to delete the user with email: <strong>{userToDelete.Email}</strong>?
        </Modal.Body>
        <Modal.Footer>
          <Button variant="secondary" onClick={() => setShowModal(false)}>Cancel</Button>
          <Button variant="danger" onClick={() => handleDeleteConfirmed(userToDelete.id)}>Delete</Button>
        </Modal.Footer>
      </Modal>
      <Footer />
    </div>
